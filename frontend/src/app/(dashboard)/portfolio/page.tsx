...
import { ExportDialog } from "@/components/shared/export-form";
...
export default function PortfolioPage() {
  ...
  const allocationData = useMemo(
    () => [
      {
        name: "Stocks",
        value: Math.max(0, totalValue - cashBalance),
        color: "var(--primary)",
      },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Note: Currently passing 'trades' from current page. 
              For full history export, you might want to fetch all trades 
              or create a specific API endpoint. */}
          <ExportDialog holdings={holdings} trades={trades} />

          <Link href="/stocks">
            <Button size="sm" className="shadow-sm border-2 border-transparent">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-2 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="rounded-full bg-primary/10 p-2 border-2 border-transparent">
        ...
        <Card className="border-2 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="rounded-full bg-emerald-500/10 p-2 border-2 border-transparent">
        ...
        <Card className="border-2 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="rounded-full bg-accent/10 p-2 border-2 border-transparent">
            ...
            <div className="mt-4">
              ...
              <p
                className={`text-2xl font-bold ${totalProfitLoss >= 0 ? "text-accent" : "text-primary"}`}
              >
                {mounted ? (
                  <>
                    {totalProfitLoss >= 0 ? "+" : ""}₹
        ...
        <Card className="border-2 shadow-sm">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="rounded-full bg-secondary/10 p-2 border-2 border-transparent">
      ...
      <Tabs defaultValue="holdings" className="space-y-6">
        <TabsList className="border-2 border-black/10 dark:border-white/10">
        ...
        <TabsContent value="holdings" className="space-y-6">
          <div className="grid gap-6 lg:grid-cols-3">
            <Card className="lg:col-span-2 overflow-hidden border-2 shadow-md">
              <CardHeader>
                    ...
                    <TableBody>
                      {mounted &&
                        holdings.map((holding) => (
                          <TableRow key={holding.symbol}>
                            ...
                            <TableCell
                              className={`text-right font-bold ${holding.profitLoss >= 0 ? "text-accent" : "text-primary"}`}
                            >
                      ...
                      {mounted && holdings.length === 0 && (
                        <TableRow>
                          ...
                          >
                            No active holdings. Start trading to build your
                            portfolio.
                          </TableCell>
                        </TableRow>
                      )}
                          ...
                          <TableCell>
                            <div className="flex flex-col">
                              ...
                              <Badge
                                ...
                                className="sm:hidden w-fit text-xs border-2"
                              >
                                {trade.type}
                              </Badge>
                            </div>
